...
function setValues() {
    ...
    if (lovedit) {
        const wordtosave = document.getElementById('word');
        const wordmean = document.getElementById('definition');
        const edit_word = document.createElement('editword');
        edit_word.textContent = 'edit';
        const divi = document.getElementById('phone');
        divi.appendChild(edit_word);
        document.getElementById('editword').innerHTML = '${word} = ${wordmean}';
